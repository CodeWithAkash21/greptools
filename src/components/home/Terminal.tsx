...
const COMMANDS = [
  {
    input: 'curl -X POST https://greptools.dev/api/format \\',
    input2: '  -H "Content-Type: application/json" \\',
    input3: '  -d \'{"tool":"json-formatter","status":"active"}\'',
    output: [
      '// Info: Everything processed locally inside sandbox.',
      '// Note: No network request was actually transmitted to the cloud.',
      '{',
      '  "status": "success",',
      '  "source": "client-side",',
      '  "data": {',
